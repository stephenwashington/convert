...
This library was written in C99 and uses the [Check](https://libcheck.github.io/check) testing suite. Its only dependencies are Check, GNU make (to build), and GNU GCC (to compile).
